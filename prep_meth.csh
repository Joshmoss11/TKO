#!/bin/csh
set me_f = '/mnt/lustre/hms-01/fs01/joshua.moss/cedar/embryo/tko_analysis/alon_bg/GSE30202_BisSeq_ES_CpGmeth.bg'
...
set flank_f = ${out_dir}'/J1_2_cut10_100bp.flank'

mkdir $out_dir
bedtools slop -i $me_f -g $mm9_s -b 1000 > $flank_f
bedtools map -c 4 -o max -null 0 -a $flank_f -b $k4_f > ${out_dir}'/k4_flank_10.bg'
